                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group row">
                         ...
                         <!-- DATA AYAH -->
                        <div class="p-3 mb-2 bg-success text-white">DATA AYAH KANDUNG</div>
                        <br>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="penghasilan_ayah" class="col-sm-3" style="margin-left: 15px; margin-top: 7px;">
                                ...
                                <option value="> 20.000.000">Lebih dari 20.000.000</option>
                            </select>
                        ...
                        <div class="form-group row">
                         ...
                         <!-- DATA IBU -->
                         <div class="p-3 mb-2 bg-info text-white">DATA IBU KANDUNG</div>
                        <br>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <span class="warning"><?php echo $error_tgl_lahir_ibu; ?></span>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <span class="warning"><?php echo $error_khusus_ibu; ?></span>
                        </div>
