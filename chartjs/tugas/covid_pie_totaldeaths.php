...
while($row = mysqli_fetch_array($ttlrcvr)){
    $country[] = $row['Country'];
    $query = mysqli_query($conn, "SELECT SUM(Total_Deaths) as Covid from tb_covid WHERE nomor='".$row['nomor']."'");
...
<head>
    ...
    <title>Covid Total Deaths Pie Chart</title>
    <script type="text/javascript" src="chart.js"></script>
</head>
<body>
    <h1 style="margin-left:230px;">Total Deaths of Covid</h1>
