...
while($row = mysqli_fetch_array($ttlrcvr)){
    $country[] = $row['Country'];
    $query = mysqli_query($conn, "SELECT SUM(New_Recovered) as Covid from tb_covid WHERE nomor='".$row['nomor']."'");
...
<head>
    ...
    <title>Covid New Recovered Doughnut Chart</title>
    <script type="text/javascript" src="chart.js"></script>
</head>
<body>
    <h1 style="margin-left:210px;">New Recovered of Covid</h1>
    <h2 style="margin-left:300px; font-weight:lighter;">Doughnut Chart</h2>
    <br>
